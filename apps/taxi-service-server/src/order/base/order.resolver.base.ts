...
import { Agency } from "../../agency/base/Agency";
...
export class OrderResolverBase {
  ...
  @graphql.ResolveField(() => Agency, {
    nullable: true,
    name: "agency",
  })
  async getAgency(@graphql.Parent() parent: Order): Promise<Agency | null> {
    const result = await this.service.getAgency(parent.id);
